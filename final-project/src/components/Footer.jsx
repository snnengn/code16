...
function Footer() {
  return (
    <>
    <footer className='bg-light border-top mt-3'>
...
<div className="mb-md-0 text-body-secondary text-wrap fw-medium">© 2024 Bursa Buyuksehir Belediyesi Halk Plajlari by Sinan Engin</div>
